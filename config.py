...
_raw_transcription_language = os.getenv("TRANSCRIPTION_LANGUAGE", "").strip().lower()
TRANSCRIPTION_LANGUAGE = None if _raw_transcription_language in ("", "auto") else _raw_transcription_language
TRANSCRIPTION_STREAM_QUALITY = os.getenv("TRANSCRIPTION_STREAM_QUALITY", "480p").strip() or "480p"
...
TRANSCRIPTION_AUDIO_QUEUE_MAX_SIZE = int(os.getenv("TRANSCRIPTION_AUDIO_QUEUE_MAX_SIZE", "30"))
TRANSCRIPTION_PAUSE_WHILE_LLM_BUSY = os.getenv("TRANSCRIPTION_PAUSE_WHILE_LLM_BUSY", "true").lower() == "true"
...
STREAMER_SPEECH_RESPONSE_COOLDOWN_SECONDS = float(os.getenv("STREAMER_SPEECH_RESPONSE_COOLDOWN_SECONDS", "90.0"))
